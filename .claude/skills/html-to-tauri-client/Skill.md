...
Source: skills/html-to-tauri-client/SKILL.md
...
---
name: html-to-tauri-client
description: "Use this skill when converting HTML/CSS prototypes into real Tauri + React client code."
---
